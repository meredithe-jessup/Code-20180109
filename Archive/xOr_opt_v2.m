function [solution, cost, route_cost, start_times, loads, route_dist, change] ...
	= Or_opt_v2(solution, cost, route_cost, heuristic, heuristic2, heuristic3, tw, service, Q, start_times, loads, dist_limit, route_dist)
...
%--------------------------------------------------------------------------
    ...
    %--------------------------------------------------------------------------
                    %At this point, we've found a cheaper solution that is feasible wrt to both vehicle loads and time windows. check the solution for
